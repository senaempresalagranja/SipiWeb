...
<?php
  ...
  $query="UPDATE `elemento` SET `Nombre_Elemento`='$Nombre_Elemento',`id_unidad_medida`='$id_unidad_medida',`valor_Elemento`='$Precio_Elemento',`Tipo_Materia_Prima`='$Tipo_Elemento',`stock`='$Stock', Nombre_Comercial='$Nombre_Elemento_Co' ,Id_Empaque=$Id_presentacion WHERE `id_Elemento`=$id_criterio";
  $resource=mysqli_query($conexion,$query);
