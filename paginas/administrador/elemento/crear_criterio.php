    ...
    <div class="container-fluid xyz">
      <div class="row">
        <div class="col-xs-10 col-sm-12 col-md-12 col-lg-12 ">
          <h1 >Nuevo Elemento <i class=" icon  icon-leaf"></i> </h1>
        </div>
      </div>
      <div class="row">
...
var Id_presentacion=document.getElementById("Id_presentacion").value;
      ...
      $("#contenedor").load("registrar_criterio.php",{Nombre_Elemento:Nombre_Elemento,id_unidad_medida:id_unidad_medida,Precio_Elemento:Precio_Elemento,Tipo_Elemento:Tipo_Elemento,Stock:Stock,Nombre_Elemento_Co:Nombre_Elemento_Co,Id_presentacion:Id_presentacion});
    }else{
