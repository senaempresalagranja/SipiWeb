...
$query="SELECT * FROM `Unidad_medida` WHERE Id_Unidad='$criterio' ";
    ...
    <div class="container-fluid xyz">
      <div class="row">
        <div class="col-xs-10 col-sm-12 col-md-12 col-lg-12">
          <h1 >Unidad de Medida <?php echo "$fila[1]"; ?> <i class=" icon icon-crop"></i> </h1>
        </div>
      </div>
      <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 form-group has-feedback">
          <input type="text" name="" class="form-control has-feedback-left" placeholder="012746" id="Codigo" value="<?php echo  $fila[1] ?>"  title="Codigo Unidad de Medida">
             <span class="icon icon-crop form-control-feedback left" aria-hidden="true"></span>
        </div>

        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 form-group has-feedback">
          <input type="text" name="" value="<?php echo  $fila[2] ?>" class="form-control has-feedback-left" id="criterio" >
           <span class="icon  icon-crop form-control-feedback left" aria-hidden="true"></span>
        </div>
      </div>
      <div class="row">
...
function actualizar() {
  ...
  var criterio=document.getElementById('criterio').value;
    var Codigo=document.getElementById('Codigo').value;
$("#contenedor").load("actualizar.php",{criterio:criterio,id_criterio:id_criterio,Codigo:Codigo})
  }else{
