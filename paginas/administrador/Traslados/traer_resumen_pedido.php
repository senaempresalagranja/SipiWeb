			...
			<tr>
				...
				while($row=mysqli_fetch_row($res))
				{
					...
					<tr class="table-bordered">
						...
						<td colspan="2"><button title="Trasladar Producto Terminado"  class="btn btn-success btn-md" onclick="trasladar_producto(<?php echo $row[0] ?>)"><i class="fa fa-info-circle"></i></button></td>
				...
				<?php
					...
					<td colspan="2"><button title="Producto Trasladado"  class="btn btn-success btn-md"><i class="fa fa-arrow-right"></i></button></td>
...
<div class="row">
	...
	<div class="col-md-6 text-center">
		<?php 
		if ($estado_pedido=="Registrado") {
			?>

			<button type="button" title="Cancelar Produccion" class="btn btn-success btn-lg fa fa-bell-slash" onclick="cancelar_produccion(<?php echo $id ?>)"></button>
			<?php 
		}
