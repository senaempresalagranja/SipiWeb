  ...
  <div class="col-md-12">
    <div class="main-wrapper">
      ...
      if ($fila==true) {
        ...
        ?>
        <div class="row" >
          <div class="col-xs-8 col-sm-5 col-md-3 col-lg-3"><h4><b>Empaque</b></h4></div>
        ...
        <div class="container-fluid" id="contenedor_productos"  style="height: 300px;  overflow: auto" >
          ...
          $sql="SELECT `Id_Empaque`, `Empaque` FROM `empaques`  WHERE `Empaque` like '%$criterio%'";
          ...
          while($row=mysqli_fetch_row($res))
          {
            ...
            <div class="row" style="border-bottom: 1px solid black;">
              <div class="col-xs-8 col-sm-5 col-md-3 col-lg-3"><?php echo $row[1]?></div>
